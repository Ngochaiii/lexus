...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.modal.index','data' => ['alert' => $actionIsModalAlert,'alignment' => $actionModalAlignment,'autofocus' => $actionIsModalAutofocused,'clickThrough' => $actionIsModalClickThrough,'closeButton' => $actionHasModalCloseButton,'closeByClickingAway' => $actionIsModalClosedByClickingAway,'closeByEscaping' => $actionIsModalClosedByEscaping,'description' => $actionModalDescription,'restoresFocus' => false,'extraModalWindowAttributeBag' => $actionExtraModalWindowAttributeBag,'extraModalOverlayAttributeBag' => $actionExtraModalOverlayAttributeBag,'footerActions' => $actionModalFooterActions,'footerActionsAlignment' => $actionModalFooterActionsAlignment,'heading' => $actionModalHeading,'icon' => $actionModalIcon,'iconColor' => $actionModalIconColor,'id' => $actionModalId,'slideOver' => $actionIsModalSlideOver,'slideOverPosition' => $actionModalSlideOverPosition,'stickyFooter' => $actionIsModalFooterSticky,'stickyHeader' => $actionIsModalHeaderSticky,'width' => $actionModalWidth,'wire:key' => $actionModalWireKey,'wire:submit.prevent' => $actionLivewireCallMountedActionName,'xOn:modalClosed' => $actionModalClosedEventHandler]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /Users/Shared/dự án /lexus/vendor/filament/actions/resources/views/action-modal.blade.php ENDPATH**/ ?>
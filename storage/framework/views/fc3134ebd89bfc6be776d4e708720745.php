...
<section class="container section" id="muc-<?php echo e($index); ?>">
    ...
    <div class="table-wrap">
        <table class="data-table">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($section['body'] ?? null)): ?><caption class="studio-sr"><?php echo e(strip_tags($section['body'])); ?></caption><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <tbody>
...
<?php /**PATH /Users/Shared/dự án /lexus/resources/views/frontend/partials/lexus-section/table.blade.php ENDPATH**/ ?>
...
>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasHeader): ?>
        ...
        >
            <?php echo e(\Filament\Support\generate_icon_html($icon, attributes: (new \Filament\Support\View\ComponentAttributeBag)
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.icon-button','data' => ['color' => 'gray','icon' => \Filament\Support\Icons\Heroicon::ChevronUp,'iconAlias' => \Filament\Support\View\SupportIconAlias::SECTION_COLLAPSE_BUTTON,'label' => __($collapsed ? 'filament::components/section.actions.expand.label' : 'filament::components/section.actions.collapse.label'),'xBind:ariaLabel' => 'isCollapsed ? ' . Js::from(__('filament::components/section.actions.expand.label')) . ' : ' . Js::from(__('filament::components/section.actions.collapse.label')),'ariaExpanded' => ''.e($collapsed ? 'false' : 'true').'','xBind:ariaExpanded' => '(! isCollapsed).toString()','xBind:ariaControls' => $hasContentContainer ? '$id(\'fi-section-content\')' : null,'xOn:click.stop' => 'isCollapsed = ! isCollapsed','class' => 'fi-section-collapse-btn']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Filament\Support\Icons\Heroicon::ChevronUp),'icon-alias' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Filament\Support\View\SupportIconAlias::SECTION_COLLAPSE_BUTTON),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__($collapsed ? 'filament::components/section.actions.expand.label' : 'filament::components/section.actions.collapse.label')),'x-bind:aria-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('isCollapsed ? ' . Js::from(__('filament::components/section.actions.expand.label')) . ' : ' . Js::from(__('filament::components/section.actions.collapse.label'))),'aria-expanded' => ''.e($collapsed ? 'false' : 'true').'','x-bind:aria-expanded' => '(! isCollapsed).toString()','x-bind:aria-controls' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hasContentContainer ? '$id(\'fi-section-content\')' : null),'x-on:click.stop' => 'isCollapsed = ! isCollapsed','class' => 'fi-section-collapse-btn']); ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasContentContainer): ?>
        <div
            <?php if($collapsible): ?>
...
<?php /**PATH /Users/Shared/dự án /lexus/vendor/filament/support/resources/views/components/section/index.blade.php ENDPATH**/ ?>